<header class="sticky">
    <div class="main-header header-style">
        ...
        <div class="main-icons">
            ...
            <a href="https://wa.me/5511957848872" target="_blank" aria-label="Entre em contato pelo WhatsApp">
                <i class="fa-brands fa-whatsapp main-whatsapp"></i></a>
        </div>
    </div>
        ...
        <div class="mobile-info">
            ...
            <div class="mobile-icons">
                <a href="https://www.instagram.com/nossarquitetura/">
                    <i class="fa-brands fa-instagram mobile-instagram" target="_blank" aria-label="Entre no instagram da NOSS e conheça mais projetos"></i>
                </a>
