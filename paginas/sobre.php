        ...
        <div class="equipe">
            <article class="perfil">
                ...
                <img class="foto-perfil" 
                    src="../assets/foto-perfil-marina-medium.webp" 
                    srcset="../assets/foto-perfil-marina-small.webp 500w,
                            ../assets/foto-perfil-marina-medium.webp 1000w,
                            ../assets/foto-perfil-marina-large.webp 1500w" 
                    sizes="(min-width:760px) 50vw, 100vw" 
                    alt="Foto em preto e branco da arquiteta sócia da Noss Marina Menossi" 
                    loading="lazy">
                <p>Arquiteta. Graduação pela FAU-USP em 2017 (Université de Perpignan, França, 2014-2015). Possui experiência em projetos de arquitetura e interiores, com foco em projetos residenciais, comerciais e de hotelaria, em âmbito nacional e internacional. Atuou como arquiteta e coordenadora de projetos (Flavia Romi Arquitetura, Studio Arthur Casas, Jacobsen Arquitetura) e como gestora de projetos executivos e obras (Loft). Possui pós-graduação em Gestão de Projetos pela FGV e MBA  em Gestão para Arquitetos e Designers pelo IPOG.</p>
            ...
            <article class="perfil">
                ...
                <img class="foto-perfil" 
                    src="../assets/foto-perfil-renan-medium.webp" 
                    srcset="../assets/foto-perfil-renan-small.webp 500w,
                                    ../assets/foto-perfil-renan-medium.webp 1000w,
                                    ../assets/foto-perfil-renan-large.webp 1500w" 
                    sizes="(min-width:760px) 50vw, 100vw" 
                    alt="Foto em preto e branco do arquiteto sócio da Noss Renan Sampaio" 
                    loading="lazy">
                <p>Arquiteto. Graduação pela FAU-USP em 2018 (Budapest University of Technology and Economics, Hungria, 2015-2016). Possui experiência com projetos de arquitetura de edificações e de interiores para diversos usos como residenciais, públicos e comerciais. Atuou como estagiário no setor público, como arquiteto e coordenador de projetos (Salinas e Freitas; MNMA Studio) e como autônomo. Possui Mestrado pela FAUUSP na área de Habitat, onde estudou a temática da produção do espaço e das possibilidades da realização do urbano e do comum.</p>
